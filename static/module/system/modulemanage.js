...
define(function (require, exports, module) {
    ...
    function getAllModule() {
        api.system.moduleManage.getAllModule(function (rep) {
        	console.log(rep);
            var module_data = rep;
            var module_data_length = rep.length;
            var dom = [];
            if (rep.result === 0) {
                ...
                for (var i = 0; i < module_data_length; i++) {
                    ...
                    dom.push('<span class="glyphicon glyphicon-trash icon-cursor icon-red delete-module tooltip-show" data-toggle="tooltip" data-placement="left" title="删 除"  module-id="' + module_data[i].menu_id + '"></span>');
                    dom.push('<span class="glyphicon glyphicon-repeat icon-blue icon-cursor update-module tooltip-show" data-toggle="tooltip" data-placement="top" title="修 改" module-name="' + module_data[i].menu_name + '"    module-id="' + module_data[i].menu_id + '"></span>');
                    dom.push('</li>');
                }
        ...
        api.system.moduleManage.getAllSecondModule(module_id, function (rep) {
            ...
            if (rep.result === 0) {
                ...
                for (var i = 0; i < module_data_length; i++) {
                    ...
                    dom.push('<td><span class="glyphicon glyphicon-trash icon-cursor second-module-delete tooltip-show icon-red" data-toggle="tooltip" data-placement="top" title="删 除"  module-id="' + module_data[i].menu_id + '"></span></td>');
                    dom.push('<td><span class="glyphicon glyphicon-edit icon-cursor second-module-update tooltip-show icon-blue"  data-toggle="tooltip" data-placement="top" title="修 改"  module-id="' + module_data[i].menu_id + '" module-name="' + module_data[i].menu_name + '" module-content="' + module_data[i].menu_content + '"  ></span></td>');
                    dom.push('</tr>');
                }
